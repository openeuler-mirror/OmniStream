...
OmniStream Flink SQL Native化架构如[图 1](#architecture-of-omnistream-flink-sql-native)所示。

**图 1** OmniStream Flink SQL Native化整体架构设计<a name="zh-cn_topic_0000002543922607_zh-cn_topic_0000002228744542_fig685102835814"></a><a id="architecture-of-omnistream-flink-sql-native"></a>
...
OmniStream Flink DataStream Native化架构如[图 2](#architecture-of-omnistream-flink-datastream-native)所示。
...
每个版本的特性变更详细信息，请参见[release_notes.md](./docs/zh/release_notes.md)
...
## 开源软件声明<a name="ZH-CN_TOPIC_0000002521198186"></a>

下载地址：

[Kunpeng BoostKit 26.0.0 大数据OmniRuntime 开源软件声明.docx](resource/Kunpeng BoostKit 26.0.0 大数据OmniRuntime 开源软件声明.docx)
