...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query17_OmniStream/q17-taskname-OmniStream.txt")
...
query17_dir = os.path.join(log_home, "query17")
if not os.path.exists(query17_dir):
    os.makedirs(query17_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query17_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query17_OmniStream/q17-taskname-OmniStream.txt")
