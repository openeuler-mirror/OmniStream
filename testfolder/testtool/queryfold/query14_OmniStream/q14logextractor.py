...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query14_OmniStream/q14-taskname-OmniStream.txt")
...
query14_dir = os.path.join(log_home, "query14")
if not os.path.exists(query14_dir):
    os.makedirs(query14_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query14_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query14_OmniStream/q14-taskname-OmniStream.txt")
