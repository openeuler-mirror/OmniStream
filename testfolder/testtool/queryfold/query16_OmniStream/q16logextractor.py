...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query16_OmniStream/q16-taskname-OmniStream.txt")
...
query16_dir = os.path.join(log_home, "query16")
if not os.path.exists(query16_dir):
    os.makedirs(query16_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query16_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query16_OmniStream/q16-taskname-OmniStream.txt")
