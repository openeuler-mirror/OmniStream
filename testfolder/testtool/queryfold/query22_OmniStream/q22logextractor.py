...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query22_OmniStream/q22-taskname-OmniStream.txt")
...
query22_dir = os.path.join(log_home, "query22")
if not os.path.exists(query22_dir):
    os.makedirs(query22_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query22_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query22_OmniStream/q22-taskname-OmniStream.txt")
