...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query12_OmniStream/q12-taskname-OmniStream.txt")
...
query12_dir = os.path.join(log_home, "query12")
if not os.path.exists(query12_dir):
    os.makedirs(query12_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query12_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query12_OmniStream/q12-taskname-OmniStream.txt")
