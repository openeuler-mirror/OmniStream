...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query18_OmniStream/q18-taskname-OmniStream.txt")
...
query18_dir = os.path.join(log_home, "query18")
if not os.path.exists(query18_dir):
    os.makedirs(query18_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query18_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query18_OmniStream/q18-taskname-OmniStream.txt")
