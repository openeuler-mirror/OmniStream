...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query1_OmniStream/q1-taskname-OmniStream.txt")
...
query1_dir = os.path.join(log_home, "query1")
if not os.path.exists(query1_dir):
    os.makedirs(query1_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query1_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query1_OmniStream/q1-taskname-OmniStream.txt")
