...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home,"testtool/queryfold/query21_OmniStream/q21-taskname-OmniStream.txt")
...
query21_dir = os.path.join(log_home, "query21")
if not os.path.exists(query21_dir):
    os.makedirs(query21_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query21_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")

output_file = os.path.join(omni_home, "testtool/queryfold/query21_OmniStream/q21-taskname-OmniStream.txt")
