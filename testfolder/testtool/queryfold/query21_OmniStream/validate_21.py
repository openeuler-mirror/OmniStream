...
flink_file = os.path.join(omni_home,"testtool/queryfold/query21_flink/query21_result_flink.txt")
omni_file = os.path.join(omni_home,"testtool/queryfold/query21_OmniStream/flink_output.txt")
task_name_file1 = os.path.join(omni_home,"testtool/queryfold/query21_flink/query21_taskname.txt")
task_name_file2 = os.path.join(omni_home,"testtool/queryfold/query21_OmniStream/q21-taskname-OmniStream.txt")
...
if not os.path.exists(flink_file) or not os.path.exists(omni_file):
    print("❌q21 failed, the txt files were not found")
    exit()
...
if flink_lines == omni_lines:
    ...
    print("❌q21 failed, output results are wrong")
