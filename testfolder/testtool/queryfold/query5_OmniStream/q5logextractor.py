...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query5_OmniStream/q5-taskname-OmniStream.txt")
...
query5_dir = os.path.join(log_home, "query5")
if not os.path.exists(query5_dir):
    os.makedirs(query5_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query5_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query5_OmniStream/q5-taskname-OmniStream.txt")
