...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query20_OmniStream/q20-taskname-OmniStream.txt")
...
query20_dir = os.path.join(log_home, "query20")
if not os.path.exists(query20_dir):
    os.makedirs(query20_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query20_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query20_OmniStream/q20-taskname-OmniStream.txt")
