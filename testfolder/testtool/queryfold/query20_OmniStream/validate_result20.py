...
flink_file = os.path.join(omni_home,"testtool/queryfold/query20_flink/query20_result_flink.txt")
omni_file = os.path.join(omni_home,"testtool/queryfold/query20_OmniStream/flink_output.txt")


task_name_file1 = os.path.join(omni_home,"testtool/queryfold/query20_flink/query20_taskname.txt")
task_name_file2 = os.path.join(omni_home,"testtool/queryfold/query20_OmniStream/q20-taskname-OmniStream.txt")
...
if check_log_for_setup_stram_task(log_file)==False:
    print("❌q20 failed, plan not triggered")
    exit(1)
...
if not os.path.exists(flink_file) or not os.path.exists(omni_file):
    print("❌q20 failed, the txt files were not found")
    exit()
...
if compare_source_lines(task_name_file1,task_name_file2)==False:
    print("❌q20 failed, native tasks do not match")

elif flink_lines == omni_lines and compare_source_lines(task_name_file1,task_name_file2):
    print("✅q20 success")
else:
    print("❌q20 failed, output results are wrong")
