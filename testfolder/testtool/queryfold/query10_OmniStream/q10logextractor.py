...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query10_OmniStream/q10-taskname-OmniStream.txt")
...
query10_dir = os.path.join(log_home, "query10")
if not os.path.exists(query10_dir):
    os.makedirs(query10_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query10_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query10_OmniStream/q10-taskname-OmniStream.txt")
