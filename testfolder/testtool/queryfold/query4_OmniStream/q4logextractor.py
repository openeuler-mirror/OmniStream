...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query4_OmniStream/q4-taskname-OmniStream.txt")
...
query4_dir = os.path.join(log_home, "query4")
if not os.path.exists(query4_dir):
    os.makedirs(query4_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query4_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query4_OmniStream/q4-taskname-OmniStream.txt")
