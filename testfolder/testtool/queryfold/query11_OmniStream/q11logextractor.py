...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query11_OmniStream/q11-taskname-OmniStream.txt")
...
query11_dir = os.path.join(log_home, "query11")
if not os.path.exists(query11_dir):
    os.makedirs(query11_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query11_dir, log_filename)
shutil.copy2(log_file, destination)


omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query11_OmniStream/q11-taskname-OmniStream.txt")
