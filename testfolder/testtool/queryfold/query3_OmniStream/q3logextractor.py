...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query3_OmniStream/q3-taskname-OmniStream.txt")
...
query3_dir = os.path.join(log_home, "query3")
if not os.path.exists(query3_dir):
    os.makedirs(query3_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query3_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query3_OmniStream/q3-taskname-OmniStream.txt")
