...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query15_OmniStream/q15-taskname-OmniStream.txt")
...
query15_dir = os.path.join(log_home, "query15")
if not os.path.exists(query15_dir):
    os.makedirs(query15_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query15_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query15_OmniStream/q15-taskname-OmniStream.txt")
