...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query19_OmniStream/q19-taskname-OmniStream.txt")
...
query19_dir = os.path.join(log_home, "query19")
if not os.path.exists(query19_dir):
    os.makedirs(query19_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query19_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query19_OmniStream/q19-taskname-OmniStream.txt")
