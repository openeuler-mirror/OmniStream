...
flink_file = os.path.join(omni_home,"testtool/queryfold/query8_flink/query8_result_flink.txt")
omni_file = os.path.join(omni_home,"testtool/queryfold/query8_OmniStream/flink_output.txt")
task_name_file1 = os.path.join(omni_home,"testtool/queryfold/query8_flink/q8_taskname.txt")
task_name_file2 = os.path.join(omni_home,"testtool/queryfold/query8_OmniStream/q8-taskname-OmniStream.txt")
...
if check_log_for_setup_stram_task(log_file)==False:
    print("❌q8 failed, plan not triggered")
    exit(1)
...
if not os.path.exists(flink_file) or not os.path.exists(omni_file):
    print("❌q8 failed, the txt files were not found")
    exit()
...
#     print("❌q8 failed, native tasks do not match")

if flink_lines == omni_lines:
    print("✅q8 success")
else:
    print("❌q8 failed, output results are wrong")
