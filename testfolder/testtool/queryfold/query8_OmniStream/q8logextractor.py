...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query8_OmniStream/q8-taskname-OmniStream.txt")
...
query8_dir = os.path.join(log_home, "query8")
if not os.path.exists(query8_dir):
    os.makedirs(query8_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query8_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query8_OmniStream/q8-taskname-OmniStream.txt")
