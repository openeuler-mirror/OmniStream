...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query7_OmniStream/q7-taskname-OmniStream.txt")
...
query7_dir = os.path.join(log_home, "query7")
if not os.path.exists(query7_dir):
    os.makedirs(query7_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query7_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query7_OmniStream/q7-taskname-OmniStream.txt")
