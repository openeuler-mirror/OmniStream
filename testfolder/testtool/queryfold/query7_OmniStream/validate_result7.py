...
flink_file = os.path.join(omni_home,"testtool/queryfold/query7_flink/query7_result_flink.txt")
omni_file = os.path.join(omni_home,"testtool/queryfold/query7_OmniStream/flink_output.txt")
task_name_file1 = os.path.join(omni_home,"testtool/queryfold/query7_flink/query7_taskname.txt")
task_name_file2 = os.path.join(omni_home,"testtool/queryfold/query7_OmniStream/q7-taskname-OmniStream.txt")
...
if check_log_for_setup_stram_task(log_file)==False:
    print("❌q7 failed, plan not triggered")
    exit(1)
...
if not os.path.exists(flink_file) or not os.path.exists(omni_file):
    print("❌q7 failed, the txt files were not found")
    exit()
...
if flink_lines == omni_lines:
    ...
    print("❌q7 failed, output results are wrong")
