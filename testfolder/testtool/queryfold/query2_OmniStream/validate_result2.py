...
flink_file = os.path.join(omni_home,"testtool/queryfold/query2_flink/query2_result_flink.txt")
omni_file = os.path.join(omni_home,"testtool/queryfold/query2_OmniStream/flink_output.txt")
task_name_file1 = os.path.join(omni_home,"testtool/queryfold/query2_flink/query2_taskname.txt")
task_name_file2 = os.path.join(omni_home,"testtool/queryfold/query2_OmniStream/q2-taskname-OmniStream.txt")
...
if check_log_for_setup_stram_task(log_file)==False:
    print("❌q2 failed, plan not triggered")
    exit(1)
...
if not os.path.exists(flink_file) or not os.path.exists(omni_file):
    print("❌ q2failed, cannot find files")
    exit()
...
#
# if not os.path.exists(flink_file) or not os.path.exists(omni_file):
#     print("❌q2 failed, the txt files were not found")
#     exit()
#
#
...
#     print("❌q2 failed, native tasks do not match")

if flink_lines == omni_lines:
    print("✅q2 success")
else:
    print("❌q2 failed, output results are wrong")
