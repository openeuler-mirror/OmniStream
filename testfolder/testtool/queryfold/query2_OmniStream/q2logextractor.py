...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query2_OmniStream/q2-taskname-OmniStream.txt")
...
query2_dir = os.path.join(log_home, "query2")
if not os.path.exists(query2_dir):
    os.makedirs(query2_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query2_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query2_OmniStream/q2-taskname-OmniStream.txt")
