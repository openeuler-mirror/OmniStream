...
if __name__ == "__main__":
    ...
    output_path = os.path.join(omni_home, "testtool/queryfold/query9_OmniStream/q9-taskname-OmniStream.txt")
...
query9_dir = os.path.join(log_home, "query9")
if not os.path.exists(query9_dir):
    os.makedirs(query9_dir)
log_filename = os.path.basename(log_file)
destination = os.path.join(query9_dir, log_filename)
shutil.copy2(log_file, destination)

omni_home = os.environ.get("OMNISTREAM_HOME")
output_file = os.path.join(omni_home, "testtool/queryfold/query9_OmniStream/q9-taskname-OmniStream.txt")
