...
public class StreamExecIncrementalGroupAggregate extends StreamExecAggregateBase {
    private static final Logger LOG = LoggerFactory.getLogger(StreamExecIncrementalGroupAggregate.class);
    ...
    private String getExtraDescription(String oldDescription, AggregateInfoList partialLocalAggInfoList,
        ...
        List<Map<String, Object>> partialLocalAggregateCalls = DescriptionUtil
                .getAggregateCalls(partialLocalAggInfoList.getActualAggregateInfos());
        aggInfoListMap.put("partialLocalAggregateCalls", partialLocalAggregateCalls);

        // incremental agg
        List<Map<String, Object>> incrementalAggregateCalls = DescriptionUtil
                .getAggregateCalls(incrementalAggInfo.getActualAggregateInfos());
        aggInfoListMap.put("incrementalAggregateCalls", incrementalAggregateCalls);


        aggInfoListMap.put("indexOfCountStar", incrementalAggInfo.getIndexOfCountStar());
        ...
        jsonMap.put("stateRetentionTime", stateRetentionTime);
        String jsonString = "";
        try {
