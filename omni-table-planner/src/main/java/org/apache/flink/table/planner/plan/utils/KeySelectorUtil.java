    ...
    public static RowDataKeySelector getRowDataSelector(
        ...
        if (keyFields.length > 0) {
            ...
            if (outClass == BinaryRowData.class) {
                BinaryRowDataKeySelector binaryRowDataKeySelector =
                        new BinaryRowDataKeySelector(keyRowType, generatedProjection);
                binaryRowDataKeySelector.setKeyFields(keyFields);
                return binaryRowDataKeySelector;
