...
public abstract class NettyMessage {
    ...
    static class BufferResponse extends NettyMessage {
        ...
        public void setLargeDataBuffer(ByteBuf largeDataBuffer) {
            this.largeDataBuffer = largeDataBuffer;
        }
        
        public ByteBuf getLargeDataBuffer() {
            return largeDataBuffer;
        }
        
        public boolean isLargeDataBuffer() {
            return largeDataBuffer != null;
        }
