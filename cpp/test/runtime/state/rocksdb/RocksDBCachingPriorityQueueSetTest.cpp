...
protected:
    ...
    std::unique_ptr<RocksDBCachingPriorityQueueSet<int, std::shared_ptr<TestElement>, TestElement::SharedPtrComparator>> createPQ(
            int keyGroupId = 0, int keyGroupPrefixBytes = 1, int32_t cacheSize = 5) {
