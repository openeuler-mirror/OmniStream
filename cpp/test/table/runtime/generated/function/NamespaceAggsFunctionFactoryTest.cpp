...
TEST(NamespaceAggsBasicFunctionFactoryTest, CreatesSupportedFunctionsCaseInsensitively) {
    ...
    auto sum = NamespaceAggsBasicFunctionFactory::create<int64_t>("LongSumAggFunction", {0}, {LONG_TYPE}, {0},
                                                                   {LONG_TYPE}, 0, LONG_TYPE);
    auto min = NamespaceAggsBasicFunctionFactory::create<int64_t>("MIN($0)", {0}, {LONG_TYPE}, {0},
                                                                   {LONG_TYPE}, 0, LONG_TYPE);
    auto max = NamespaceAggsBasicFunctionFactory::create<int64_t>("MAX($0)", {0}, {LONG_TYPE}, {0},
                                                                   {LONG_TYPE}, 0, LONG_TYPE);
    auto avg = NamespaceAggsBasicFunctionFactory::create<int64_t>("AVG($0)", {0}, {LONG_TYPE}, {0, 1},
                                                                   {LONG_TYPE, LONG_TYPE}, 0, LONG_TYPE);
...
TEST(NamespaceAggsBasicFunctionFactoryTest, RejectsUnsupportedFunctionAndWrongSlotCount) {
    EXPECT_THROW(
            NamespaceAggsBasicFunctionFactory::create<int64_t>("MEDIAN", {0}, {LONG_TYPE}, {0}, {LONG_TYPE}, 0,
                                                                LONG_TYPE),
            std::logic_error);
    EXPECT_THROW(
            NamespaceAggsBasicFunctionFactory::create<int64_t>("AVG", {0}, {LONG_TYPE}, {0}, {LONG_TYPE}, 0,
                                                                LONG_TYPE),
            std::logic_error);
}
