...
public:
    ...
    public:
        explicit CachedPositionMarker(PositionMarker* positionMarker) : positionMarker(positionMarker)
        {
            update();
    ...
    BufferConsumer(Buffer* buffer_, PositionMarker* writerPosition, int currentReaderPosition)
        : buffer(buffer_),
