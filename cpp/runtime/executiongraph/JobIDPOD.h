...
public:
    ...
    long getUpperPart() const
    {
        return upperPart;
    }
    void setUpperPart(long long upper)
    {
        upperPart = upper;
    }

    long getLowerPart() const
    {
        return lowerPart;
    }
    void setLowerPart(long long lower)
    {
        lowerPart = lower;
    }
    ...
    {
        return "JobIDPOD{ upperPart=" + std::to_string(upperPart) + ", lowerPart=" + std::to_string(lowerPart) + '}';
    }
