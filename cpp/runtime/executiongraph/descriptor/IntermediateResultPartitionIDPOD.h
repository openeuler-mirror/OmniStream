...
namespace omnistream {
    ...
    public:
        ...
        void setIntermediateDataSetID(const AbstractIDPOD& intermediateDataSetID_) { this->intermediateDataSetID = intermediateDataSetID_; }

        int getPartitionNum() const { return partitionNum; }
        void setPartitionNum(int partitionNum_) { this->partitionNum = partitionNum_; }
