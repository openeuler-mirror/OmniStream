...
public:
    ...
    void updateInputChannel(const ResourceIDPOD& localLocation, const ShuffleDescriptorPOD& shuffleDescriptor);
...
private:
    ...
    std::optional<std::shared_ptr<InputChannel>> getChannel(
