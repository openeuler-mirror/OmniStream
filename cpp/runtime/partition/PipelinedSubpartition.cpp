    ...
    while (!buffers.isEmpty()) {
        ...
        if (buffer == nullptr) {
            ...
            if (bufferConsumer->isFinished()) {
                ...
                bufferConsumerWithPartialRecordLength->getBufferConsumer()->close();
            }
...
{
    return bufferConsumerWithPartialRecordLength->getBufferConsumer()->build();
}
