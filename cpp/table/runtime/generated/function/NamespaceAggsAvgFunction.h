...
template<typename N>
class NamespaceAggsAvgFunction : public NamespaceAggsBasicFunction<N> {
public:
    NamespaceAggsAvgFunction(std::vector<int32_t> argIndexes, std::vector<int32_t> inputTypeIds,
