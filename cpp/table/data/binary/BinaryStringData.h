...
public:
    ...
    // BinaryStringData(MemorySegment *segments[], int offset, int sizeInBytes) : LazyBinaryFormat(segments, offset,
    // sizeInBytes) {}; BinaryStringData(MemorySegment *segments[], int offset, int sizeInBytes, std::u32string* str) :
