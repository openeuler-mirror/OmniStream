...
TEST(KeySelectorTest, SelectFromVB)
{
    ...
    std::vector<int> keyTypes{
        ...
        omniruntime::type::OMNI_INT,
        omniruntime::type::OMNI_TIMESTAMP_WITHOUT_TIME_ZONE};
