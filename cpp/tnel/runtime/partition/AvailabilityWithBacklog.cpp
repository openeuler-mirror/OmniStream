...
AvailabilityWithBacklog::AvailabilityWithBacklog(bool isAvailable, int backlog)
...
AvailabilityWithBacklog::AvailabilityWithBacklog(const AvailabilityWithBacklog& other_)
