...
public:
    ...
    void checkpointState(
        ...
        bool isTaskFinished,
        std::shared_ptr<omnistream::Supplier<bool>> isRunning) override;
...
private:
    ...
    void RegisterAsyncCheckpointRunnable(int64_t checkpointId, AsyncCheckpointRunnable* asyncCheckpointRunnable);
